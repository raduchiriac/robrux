...
const SEARCH_BBOX_GIG = gql`
  query gigs($limit: Int!, $sort: String!, $bbox: [[Float]]!, $searchingFor: String, $category: Int) {
    gigs(limit: $limit, sort: $sort, bbox: $bbox, searchingFor: $searchingFor, category: $category) {
      _id
      _providerName
      _providerAvatar
      _rating
